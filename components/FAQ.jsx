...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-20 md:py-28 bg-dark relative">
        ...
        <div className="space-y-2">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              className="rounded-xl border border-white/5 hover:border-navy-light/20 transition-colors duration-300 overflow-hidden"
            >
              <button
              ...
              >
                ...
                <motion.svg
                  ...
                  className="w-4 h-4 text-navy-light shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}

        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group p-6 rounded-2xl bg-dark-gray/50 border border-white/5 hover:border-navy-light/50 transition-all duration-300 cursor-pointer flex flex-col"
            >
              <div className="text-navy-light mb-4 group-hover:scale-110 transition-transform duration-300">
                {service.icon}
              </div>
              <h3 className="text-lg font-semibold mb-1">{service.title}</h3>
              <p className="text-navy-light font-bold text-sm mb-3">
                {service.price}
              </p>
